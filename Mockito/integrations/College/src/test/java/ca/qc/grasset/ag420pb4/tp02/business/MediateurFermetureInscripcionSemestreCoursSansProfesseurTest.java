...
public class MediateurFermetureInscripcionSemestreCoursSansProfesseurTest {
    ...
    public MediateurFermetureInscripcionSemestreCoursSansProfesseurTest() {
    ...
    public void test() throws ExceptionFactureIntrouvable, ExceptionSystemeFacturationIndisponible {
        ...
        OffreDeCours offreDeCours = mockValue.getOffreDeCoursInvalide();
        ...
        Mockito.when(registreOffreDeCours.obtenir(Mockito.any(OffreDeCours.class)))
                .thenReturn(offreDeCours);
        ...
        mediateurFermetureInscripcionSemestre.executer(mockValue.getInscriptionSemestreInvalide());
